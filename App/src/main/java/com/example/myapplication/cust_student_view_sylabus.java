...
public class cust_student_view_sylabus extends BaseAdapter {
    ...
    public cust_student_view_sylabus(Context appcontext, String[]course, String[]title, String[]file, String [] id)
    {
    ...
    public View getView(int i, final View view, ViewGroup viewGroup) {
        ...
        if(view==null)
        {
            ...
            gridView=inflator.inflate(R.layout.cust_user_view_sylabus,null);
