...
public class fc_edit_sylabus extends AppCompatActivity implements View.OnClickListener {
    TextView coursename;
    EditText titl;
    ...
    public void onClick(View v) {
        ...
        if(v==add_btn) {
            ...
            String url = "http://" + hu + ":8000/stock/faculty_update_sylabus/";
...
//                String id=sh.getString("uid","");
                    params.put("titl", titl.getText().toString());
