...
public class Studentviewvaccancies extends AppCompatActivity {
...
//        String uid=sh.getString("uid","");
        ...
        String url = "http://" + hu + ":8000/stock/studentviewcarriers/";
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                listfaculty.setAdapter(new cust_student_viewcarrier(getApplicationContext(),date,title,discription,file,lastdate,id));
