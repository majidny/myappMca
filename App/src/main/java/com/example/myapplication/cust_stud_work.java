...
public class cust_stud_work extends BaseAdapter {
    String[] course,batch,desc,id;
    private Context context;



    public cust_stud_work(Context appcontext, String[]course, String[]bacth, String[]desc, String [] id)
    {
    ...
    public View getView(int i, final View view, ViewGroup viewGroup) {
        ...
        if(view==null)
        {
            ...
            gridView=inflator.inflate(R.layout.cust_stud_view_work,null);
        ...
        TextView tv1=(TextView)gridView.findViewById(R.id.textView106);
        TextView tv2=(TextView)gridView.findViewById(R.id.textView107);
        TextView tv3=(TextView)gridView.findViewById(R.id.textView108);
