...
public class cust_view_work extends BaseAdapter {
    String[] course,batch,desc,id;
    private Context context;



    public cust_view_work(Context appcontext, String[]course, String[]bacth, String[]desc, String [] id)
    {
    ...
    public View getView(int i, final View view, ViewGroup viewGroup) {
        ...
        if(view==null)
        {
            ...
            gridView=inflator.inflate(R.layout.cust_view_work,null);
        ...
        TextView tv3=(TextView)gridView.findViewById(R.id.textView86);
