...
public class cust_view_sylabus extends BaseAdapter {
    ...
    public cust_view_sylabus(Context appcontext, String[]course, String[]title, String[]file, String [] id)
    {
    ...
    public View getView(int i, final View view, ViewGroup viewGroup) {
        ...
        if(view==null)
        {
            ...
            gridView=inflator.inflate(R.layout.cust_view_sylabus,null);
        ...
        Button bt1=(Button) gridView.findViewById(R.id.button18);
        Button bt2=(Button) gridView.findViewById(R.id.button17);
        Button bt3=(Button) gridView.findViewById(R.id.button19);
        bt1.setTag(i);
        bt2.setTag(i);
        bt3.setTag(i);
...
//                Toast.makeText(context,url_main,Toast.LENGTH_SHORT).show();
        ...
        bt2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                String hu = sh.getString("ip", "");
                String url = "http://" + hu + ":8000/stock/faculty_del_sylabus/";
                            ...
                            public void onResponse(String response) {
                                ...
                                try {
                                    ...
                                    if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                        ...
                                        Intent ins= new Intent(context,fc_view_sylabus.class);
...
//                params.put("mac",maclis);
        ...
        bt3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ed.putString("titl",title[pos]);
                ed.commit();
                Intent ij=new Intent(context,fc_edit_sylabus.class);
