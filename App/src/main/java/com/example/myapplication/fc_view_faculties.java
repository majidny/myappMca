...
public class fc_view_faculties extends AppCompatActivity {
    ...
    String[] name,image,email,phone,housenme,place,post,pin;
...
//                                }
                                ...
                                listfaculty.setAdapter(new cust_view_faculty(getApplicationContext(),image,name,email,phone,housenme,place,post,pin));
