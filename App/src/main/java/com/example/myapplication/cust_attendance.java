...
public class cust_attendance extends BaseAdapter {
    String[] date,status;
    private Context context;



    public cust_attendance(Context appcontext, String[] date, String[] status)
    {
    ...
    public View getView(int i, final View view, ViewGroup viewGroup) {
        ...
        if(view==null)
        {
            ...
            gridView=inflator.inflate(R.layout.cust_attendance,null);
        ...
        TextView tvdate=(TextView)gridView.findViewById(R.id.textView60);
        TextView tvstatus=(TextView)gridView.findViewById(R.id.textView61);
