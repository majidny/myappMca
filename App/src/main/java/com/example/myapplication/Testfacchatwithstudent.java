...
public class Testfacchatwithstudent extends AppCompatActivity implements View.OnClickListener {
	ListView l1;
	EditText src;
	Button b1;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		adapterMessages = new MessagesAdapter(Testfacchatwithstudent.this);
...
//        requestQueue.add(postRequest);
	...
	public void onClick(View view) {
		...
		SharedPreferences sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
		String ip=sh.getString("ip","");
		String localhost="http://"+ip+":8000/stock/and_facchatinsert/";
//        Toast.makeText(getApplicationContext(),localhost,Toast.LENGTH_SHORT).show();
...
src.setText("");
			...
			protected Map<String, String> getParams() {
				...
				params.put("sid", sh.getString("studentid", ""));
				params.put("flogid",sh.getString("lid", ""));
	...
	Runnable ad=new Runnable() {
		...
		public void run() {
			...
			SharedPreferences sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
			String ip=sh.getString("ip","");
			String localhost="http://"+ip+":8000/stock/facviewchat/";
//            Toast.makeText(getApplicationContext(),localhost,Toast.LENGTH_SHORT).show();
